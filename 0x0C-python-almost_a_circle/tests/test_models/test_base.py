#!/usr/bin/python3
"""
    Unittest module for class Base.py
    Classes:
...
class TestBase_instantiation(unittest.TestCase):
    ...
    def test_nb_instances_after_input_id(self):
        b1 = Base()
        b2 = Base(18)
        b3 = Base()
    ...
    def test_bytes_id(self):
        self.assertEqual(b'1234', Base(b'1234').id)
...
class TestBase_to_json_string(unittest.TestCase):
    """Test Case fo method to_json_string of Base Class """
    ...
    def test_square_dict_length(self):
        s = Square(10, 2, 3, 4)
    ...
    def test_too_many_arga(self):
        with self.assertRaises(TypeError):
            Base.to_json_string([], 10)


class TestBase_save_to_file(unittest.TestCase):
    """ Test case for Base class method save_to_file """

    @classmethod
    def tearDown(self):
        """File cleanup after each test method"""
        try:
            os.remove("Base.json")
        except IOError:
            pass
    ...
    def test_save_to_file_square_json(self):
        s = Square(10, 7, 2, 8)
        Square.save_to_file([s])
        with open("Square.json", "r") as f:
            self.assertTrue(len(f.read()) == 39)

    def test_save_to_file_rectangle_json(self):
        r = Rectangle(10, 7, 2, 8, 5)
        Rectangle.save_to_file([r])
        with open("Rectangle.json", "r") as f:
            self.assertTrue(len(f.read()) == 53)

    def test_save_to_file_Base_json(self):
        s = Square(10, 7, 2, 8)
        Base.save_to_file([s])
    ...
    def test_empty_list_as_arg(self):
        Square.save_to_file([])
        with open("Square.json", "r") as f:
            self.assertEqual("[]", f.read())
    ...
    def test_save_to_file_more_than_one_arg(self):
        with self.assertRaises(TypeError):
            Square.save_to_file([], 30)


class TestBase_from_json_string(unittest.TestCase):
    """ Test case for class method """
...
class TestBase_create(unittest.TestCase):
    """ Test case for create method of Base class."""

    def test_original_rectangle(self):
    ...
    def test_create_instance_diff(self):
        r1 = Rectangle(3, 5, 1, 2, 7)
        r1_dictionary = r1.to_dictionary()
        r2 = Rectangle.create(**r1_dictionary)
    ...
    def test_create_square_is_diff(self):
        s1 = Square(3, 5, 1, 7)
        s1_dictionary = s1.to_dictionary()
        s2 = Square.create(**s1_dictionary)
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """ Test case for method save_to_file_csv """
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """ Test case for method load_from_file_csv """
    @classmethod
    def tearDown(self):
        """Delete any created files."""
        try:
