...
class Rectangle:
    ...
    def square(cls, size=0):
        """Creates a new instance of the class Rectangle
        Args:
            size (int): width and height of the new instance
        Returns:
            Rectangle: A new instance of class Rectangle
        """
